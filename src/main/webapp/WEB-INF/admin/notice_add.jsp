		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				...
				<div align="center">
					...
					<form action="#" method="post" name="form1" onSubmit="return verifyInfo()">


						<table id="table2" class="line_table" style="width: 100%; margin: 0; padding: 0" cellSpacing="0" cellPadding="0">
							<tr>
								<td class="line_table" align="right" width="10%">
									<span class="left_bt2">公告标题：</span>
								</td>
								<td class="line_table" width="90%">
									<input type="text" name="name" size="45" value="">
								</td>
							</tr>
							<tr>
								<td class="line_table" align="right" width="10%">
									<span class="left_bt2">公告内容：</span>
								</td>
								<td class="line_table" width="90%">
									<textarea rows="14" name="content" cols="45"></textarea>
								</td>
							</tr>
							<tr>
