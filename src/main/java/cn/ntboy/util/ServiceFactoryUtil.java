...
public class ServiceFactoryUtil {
        ...
        try {
            ...
            while (dirs.hasMoreElements()) {
                ...
                if ("file".equals(protocol)) {
                    ...
                    // 如果是jar包文件
                    findAndAddClassesInPackageByJar(pack, url, recursive, classes);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
     ...
     */
    private static void findAndAddClassesInPackageByJar(String packageName, URL url, boolean recursive, Set<Class<?>> classes) {
        ...
        try {
            ...
            if(recursive){
                pattern = packageDirName+"(/[\\w$]*)*\\.class";
            }else{
                pattern = packageDirName+"(/[\\w$]*)\\.class";
            }
